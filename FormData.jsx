  ...
  <div>
    <form className="form-signin">
      ...
      <button
        ...
        type="submit"
        onClick={() => onClick("SuccessView")}
      >
        Sign Me Up!
      </button>
      <p className="mt-5 mb-3 text-muted">&copy; Pruthviraj</p>
    </form>
  </div>
);
...
const SuccessView = ({ onClick }) => (
  <div className="jumbotron jumbotron-fluid">
    <div className="container">
      ...
      <p className="lead">
        You have been successfully signed up to the Newsletter, look forward to
        lots of awesome content!!
      </p>
      <button
        className="btn btn-lg btn-success"
        type="submit"
        onClick={() => onClick("SignInView")}
      >
        Go Back and Sign up with another ID
      </button>
    </div>
  </div>
);
